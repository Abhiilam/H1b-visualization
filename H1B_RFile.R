...
df <- read.csv("C:/Users/abhii/OneDrive/Desktop/umass D/Data Vizualisation Independent Study/project/Files/h1b_kaggle.csv")
USADf = subset(df, EMPLOYER_COUNTRY == "UNITED STATES OF AMERICA" & VISA_CLASS == 'H-1B', select=�..CASE_NUMBER:ORIGINAL_CERT_DATE)
USADf = subset(USADf, select = -c(�..CASE_NUMBER,EMPLOYER_BUSINESS_DBA,EMPLOYER_COUNTRY,EMPLOYER_ADDRESS,EMPLOYER_CITY,EMPLOYER_COUNTRY,
